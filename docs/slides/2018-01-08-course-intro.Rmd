...
<img src="https://images.gr-assets.com/books/1386922948l/18286.jpg"/>
...
<img src="https://images.gr-assets.com/books/1386922948l/18286.jpg" height=100px/>
...
From every point in space, $(x,y,z)$, at each time $t$, looking in every direction $(\theta, \phi)$, there is a set of wavelengths $\lambda$...

How does a {biological, artificial} visual system detect this and convert it into information about objects, positions, and motions?

Adelson, E. H., & Bergen, J. R. (1991). The plenoptic function and the elements of early vision. Vision and Modeling Group, Media Laboratory, Massachusetts Institute of Technology. Retrieved from http://faculty.cs.tamu.edu/jchai/CPSC641/elements91.pdf

---
class: center

# Computer images as arrays of numbers

Digital images are arrays of numbers that specify position $(x,y)$, and wavelength $\lambda$ as **R**ed, **G**reen, **B**lue (RGB) values. 
Movies are just $(x, y)$ arrays of $(R, G, B)$ values across time $t$.

---

```{r}
path2parrots <- system.file('extdata/parrots.png', package='imager')
parrots <- load.image(path2parrots)
plot(parrots) 
```
...
```{r}
hist(R(parrots), main = "Histogram of Red values")
```

---

```{r}
hist(G(parrots), main = "Histogram of Green values")
```

---

```{r}
hist(B(parrots), main = "Histogram of Blue values")
```
...
<a href="https://psych.ucalgary.ca/PACE/VA-Lab/Marcela/Pages/page35a.html">
<img src="https://psych.ucalgary.ca/PACE/VA-Lab/Marcela/Assets/webreadypics/CSF.gif"/>
</a>
...
<img src="http://i.dailymail.co.uk/i/pix/2014/04/28/article-2615115-1D6D180F00000578-16_964x638.jpg" height=500px/>
...
<a href="https://doi.org/10.1016/j.visres.2009.08.005">
<img src="img/vision-research-49-22-asd.jpg" height=500px>
</a>
